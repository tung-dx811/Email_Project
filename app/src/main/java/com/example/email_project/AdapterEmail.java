...
public class AdapterEmail extends BaseAdapter {
    private List<Email> listEmail;
    private LayoutInflater layoutInflater;
    private Context context;

    public AdapterEmail(Context context, List<Email> listEmail){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView==null){
            convertView=layoutInflater.inflate(R.layout.list_email,null);
        ...
        holder.nameView.setText(email.getTitle());
        holder.timeView.setText(email.getTime());
        holder.contentView.setText(email.getContent());
        holder.imageView.setImageResource(R.drawable.ic_baseline_star_outline_24);
        return convertView;
    }
